    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                Log.e("actUP3:","X1:"+ startDownX + "X2:"+ event.getX()
                            + "Y1:"+ startDownY + "Y2:"+ event.getY());
...
//
//                    Log.e("actUP3:","X1:"+ startX + "X2:"+ event.getX()
//                            + "Y1:"+ startY + "Y2:"+ event.getY());
//
//                }
